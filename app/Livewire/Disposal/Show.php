...
class Show extends Component
{
    ...
    protected function blankEditItem(): array
    {
        return [
            ...
            'qty' => 1, 'unit' => '', 'condition' => '', 'functional_status' => '',
    ...
    public function openEdit(): void
    {
        ...
        $this->ef = $this->record->items->map(fn ($it) => [
            ...
            'functional_status' => $it->functional_status ?? '',
            'reason' => $it->reason ?? '',
    ...
    public function saveEdit(): void
    {
        ...
        foreach (array_values($this->ef) as $i => $row) {
            $payload = [
                ...
                'functional_status' => in_array($row['functional_status'] ?? null, ['usable', 'partial', 'unusable'], true) ? $row['functional_status'] : null,
