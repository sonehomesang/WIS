<x-app-layout>
    ...
    @php
        ...
        $cards = [
            ['label' => 'Users', 'desc' => 'ຜູ້ໃຊ້ · approve · lock', 'perm' => 'users.view',
                'icon' => 'M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0Zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0Z'],
            ['label' => 'Roles & permissions', 'desc' => 'matrix 21×6 + scope', 'perm' => 'roles.view',
            ...
            ['label' => 'Organization', 'desc' => 'Units · Depts · Locations · Buildings · Rooms', 'perm' => 'units.view',
                'icon' => 'M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21'],
            ['label' => 'Units of measure', 'desc' => 'pcs · kg · m …', 'perm' => 'units.view',
            ...
            ['label' => 'Suppliers', 'desc' => 'ຮ້ານຄ້າ supplier', 'perm' => 'supplier.view',
                'icon' => 'M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12'],
            ['label' => 'Audit log', 'desc' => 'ບັນທຶກການກະທຳ 90 ມື້', 'perm' => 'audit.view',
                'icon' => 'M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z'],
            ['label' => 'Reports', 'desc' => 'ລາຍງານ + export', 'perm' => 'reports.view',
                'icon' => 'M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z'],
            ['label' => 'Notifications', 'desc' => 'templates + toggles', 'perm' => 'settings.view',
            ...
            ['label' => 'System', 'desc' => 'VAT · letterhead', 'perm' => 'settings.view',
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                @foreach ($cards as $card)
                    @can($card['perm'])
                        <a href="#" class="block bg-white shadow-sm rounded-lg p-5 border border-gray-100 hover:border-gray-300 hover:shadow transition">
                            ...
                            <p class="mt-1 text-[11px] text-gray-400">ກຳລັງພັດທະນາ (phase ຕໍ່ໄປ)</p>
                        </a>
                    @endcan
                @endforeach
            </div>
