    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 space-y-4">
        ...
        @if ($showDispatch)
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4"><div class="bg-white rounded-lg p-5 w-full max-w-sm space-y-3">
                ...
                <div class="flex justify-end gap-2"><button wire:click="$set('showDispatch', false)" class="border rounded px-3 py-1.5 text-sm">ປິດ</button><button wire:click="confirmDispatch" class="bg-amber-600 text-white rounded px-3 py-1.5 text-sm">ຢືນຢັນ Dispatch</button></div>
            </div></div>
        @endif
        @if ($showDelivery)
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4"><div class="bg-white rounded-lg p-5 w-full max-w-md space-y-3 max-h-[90vh] overflow-y-auto">
                <h3 class="font-medium text-gray-800">ຢືນຢັນສົ່ງເຖິງ — ຮູບ (delivery)</h3>
        ...
        @if ($showReturn)
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4"><div class="bg-white rounded-lg p-5 w-full max-w-sm space-y-3">
                ...
                <div class="flex justify-end gap-2"><button wire:click="$set('showReturn', false)" class="border rounded px-3 py-1.5 text-sm">ປິດ</button><button wire:click="returnRejected" class="bg-red-600 text-white rounded px-3 py-1.5 text-sm">ຢືນຢັນ</button></div>
            </div></div>
        @endif
        @if ($showCancel)
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4"><div class="bg-white rounded-lg p-5 w-full max-w-sm space-y-3">
